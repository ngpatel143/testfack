...
namespace Ibillmaker\Hub\CoreBundle\Menu;
...
//            'routeParameters'=> array('criteria[type]'=>'client'),
//            'labelAttributes' => array('icon' => 'glyphicon glyphicon-user'),
//        ))->setLabel($this->translate(sprintf('sylius.backend.menu.%s.users', $section)));
        $child->addChild('client', array(
            'route' => 'sylius_backend_user_index',
            'routeParameters'=> array('criteria[type]'=>'client'),
            'labelAttributes' => array('icon' => 'glyphicon glyphicon-user'),
        ))->setLabel($this->translate(sprintf('sylius.backend.menu.%s.clients', $section)));
        $child->addChild('vendor', array(
            'route' => 'sylius_backend_user_index',
            'routeParameters'=> array('criteria[type]'=>'vendor'),
            'labelAttributes' => array('icon' => 'glyphicon glyphicon-user'),
        ))->setLabel($this->translate(sprintf('sylius.backend.menu.%s.vendors', $section)));
